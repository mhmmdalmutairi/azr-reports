  ...
  return (
    <>
      <PageHero
        badge="تواصل معنا"
        title="ابدأ مشروعك"
        description="لديك فكرة جريئة أو تحدٍّ معقد؟ تواصل معنا وسنساعدك في تحويله إلى نتائج ملموسة."
      />
              ...
              <ScrollReveal>
                <div className="space-y-8">
                  ...
                  <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06]">
                    <h4 className="text-white font-semibold mb-2">ساعات العمل</h4>
                    <p className="text-white/50 text-sm">الأحد — الخميس</p>
                    <p className="text-white/50 text-sm">9:00 ص — 6:00 م</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
