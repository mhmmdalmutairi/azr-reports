...
export default function Stats({ locale = "ar" }: StatsProps) {
  return (
    <section className="relative py-24 md:py-32 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[var(--ink)]/50 to-transparent pointer-events-none" />
          ...
          {stats.map((stat, i) => (
            <ScrollReveal key={i} delay={i * 0.12} className="text-center group">
              <div className="relative py-6">
                ...
                <div className="text-6xl md:text-7xl lg:text-8xl font-bold text-[var(--azr)] mb-4 group-hover:scale-[1.08] group-hover:brightness-125 transition-all duration-300">
