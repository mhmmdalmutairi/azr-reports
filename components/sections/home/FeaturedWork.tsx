...
const categoryGradients: Record<string, string> = {
  campaigns: "from-[#967BB6]/20 via-[#967BB6]/5 to-[#050B14]",
  "social-impact": "from-[#22C55E]/15 via-[#22C55E]/5 to-[#050B14]",
  strategy: "from-[#614A78]/15 via-[#614A78]/5 to-[#050B14]",
  hospitality: "from-[#3B82F6]/15 via-[#3B82F6]/5 to-[#050B14]",
  business: "from-[#F59E0B]/15 via-[#F59E0B]/5 to-[#050B14]",
};
...
export default function FeaturedWork({ locale = "ar" }: FeaturedWorkProps) {
  ...
  return (
    <section className="relative section-padding bg-[#050B14] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <ScrollReveal>
            <Link
              ...
              className="group block rounded-2xl overflow-hidden border border-white/[0.06] hover:border-[#967BB6]/20 transition-all duration-500 card-hover"
            >
              <div className="relative aspect-[21/9] md:aspect-[21/8]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-[#967BB6] text-sm font-medium">{featured[0].client[locale]}</span>
                    <span className="text-white/20">·</span>
                    <span className="text-white/40 text-sm">{featured[0].category[locale]}</span>
                  </div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-3 group-hover:text-[#967BB6] transition-colors">
                    {featured[0].title[locale]}
                  </h3>
                  <p className="text-white/50 text-base mb-4 max-w-2xl">
                    {featured[0].description[locale]}
                  </p>
                  <p className="text-[#967BB6] font-semibold">
                  ...
                  <div className="relative aspect-[4/3]">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-[#967BB6] text-xs font-medium">{project.client[locale]}</span>
                        <span className="text-white/20">·</span>
                        <span className="text-white/40 text-xs">{project.category[locale]}</span>
                      </div>
                      <h3 className="text-lg md:text-xl font-bold text-white mb-2 group-hover:text-[#967BB6] transition-colors">
                        {project.title[locale]}
                      </h3>
                      <p className="text-white/50 text-sm mb-3 line-clamp-2">
                        {project.description[locale]}
                      </p>
                      <p className="text-[#967BB6] text-sm font-semibold">
        ...
        <ScrollReveal delay={0.3} className="text-center mt-12">
          <Link
            href={isRTL ? "/work" : "/en/work"}
            className="inline-flex px-8 py-3 border border-white/20 hover:border-[#967BB6]/40 text-white font-medium rounded-lg transition-colors"
          >
